...
pub type Enum_jv_print_flags = ::libc::c_uint;
...
pub const JV_PRINT_TAB: ::libc::c_uint = 64;
pub const JV_PRINT_ISATTY: ::libc::c_uint = 128;
pub const JV_PRINT_SPACE0: ::libc::c_uint = 256;
pub const JV_PRINT_SPACE1: ::libc::c_uint = 512;
pub const JV_PRINT_SPACE2: ::libc::c_uint = 1024;
...
pub const JQ_DEBUG_TRACE: ::libc::c_uint = 1;
pub enum Struct_jq_state { }
pub type jq_state = Struct_jq_state;
pub type jq_msg_cb =
    ::std::option::Option<extern "C" fn(arg1: *mut ::libc::c_void, arg2: jv)
                              -> ()>;
pub type jq_input_cb =
    ::std::option::Option<extern "C" fn(arg1: *mut jq_state,
                                        arg2: *mut ::libc::c_void) -> jv>;
pub enum Struct_jq_util_input_state { }
pub type jq_util_input_state = *mut Struct_jq_util_input_state;
...
extern "C" {
    ...
    pub fn jv_identical(arg1: jv, arg2: jv) -> ::libc::c_int;
    ...
    pub fn jq_set_error_cb(arg1: *mut jq_state, arg2: jq_msg_cb,
                           arg3: *mut ::libc::c_void) -> ();
    pub fn jq_get_error_cb(arg1: *mut jq_state, arg2: *mut jq_msg_cb,
                           arg3: *mut *mut ::libc::c_void) -> ();
    pub fn jq_set_nomem_handler(arg1: *mut jq_state,
                                arg2:
                                    ::std::option::Option<extern "C" fn(arg1:
                                                                            *mut ::libc::c_void)
                                                              -> ()>,
    ...
    pub fn jq_compile(arg1: *mut jq_state, arg2: *const ::libc::c_char)
     -> ::libc::c_int;
    pub fn jq_compile_args(arg1: *mut jq_state, arg2: *const ::libc::c_char,
                           arg3: jv) -> ::libc::c_int;
    pub fn jq_dump_disassembly(arg1: *mut jq_state, arg2: ::libc::c_int)
     -> ();
    pub fn jq_start(arg1: *mut jq_state, value: jv, arg2: ::libc::c_int)
     -> ();
    pub fn jq_next(arg1: *mut jq_state) -> jv;
    pub fn jq_teardown(arg1: *mut *mut jq_state) -> ();
    pub fn jq_set_input_cb(arg1: *mut jq_state, arg2: jq_input_cb,
                           arg3: *mut ::libc::c_void) -> ();
    pub fn jq_get_input_cb(arg1: *mut jq_state, arg2: *mut jq_input_cb,
                           arg3: *mut *mut ::libc::c_void) -> ();
    pub fn jq_set_debug_cb(arg1: *mut jq_state, arg2: jq_msg_cb,
                           arg3: *mut ::libc::c_void) -> ();
    pub fn jq_get_debug_cb(arg1: *mut jq_state, arg2: *mut jq_msg_cb,
                           arg3: *mut *mut ::libc::c_void) -> ();
    ...
    pub fn jq_util_input_init(arg1: jq_msg_cb, arg2: *mut ::libc::c_void)
     -> jq_util_input_state;
    pub fn jq_util_input_set_parser(arg1: jq_util_input_state,
                                    arg2: *mut jv_parser, arg3: ::libc::c_int)
     -> ();
    pub fn jq_util_input_free(arg1: *mut jq_util_input_state) -> ();
    pub fn jq_util_input_add_input(arg1: jq_util_input_state, arg2: jv) -> ();
    pub fn jq_util_input_errors(arg1: jq_util_input_state) -> ::libc::c_int;
    pub fn jq_util_input_next_input(arg1: jq_util_input_state) -> jv;
    pub fn jq_util_input_next_input_cb(arg1: *mut jq_state,
                                       arg2: *mut ::libc::c_void) -> jv;
